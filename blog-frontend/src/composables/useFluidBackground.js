/**
 * WebGL Fluid Simulation composable for Vue 3
 * Adapted from PavelDoGreat/WebGL-Fluid-Simulation
 */

export function useFluidBackground() {
  let canvas = null
  let gl = null
  let ext = null
  ...
  // Programs
  let blurProgram, copyProgram, clearProgram, colorProgram
  ...
  let curlProgram, vorticityProgram, pressureProgram
  let gradientSubtractProgram, displayMaterial
